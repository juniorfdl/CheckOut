...
uses
  ...
  ExtCtrls, dxGDIPlusClasses, Placemnt, jpeg, ppModule, raCodMod, RDprint,
  ppParameter, RXCtrls, AdvOfficeStatusBar, AdvOfficeStatusBarStylers,
...
type
  TFormPrincipalRelatorios = class(TForm)
    ...
    SQLVendasCUPON2TOTITENS: TBCDField;
    SQLVendasCUPON2DESC: TBCDField;
    SQLVendasCUPON2ACRESC: TBCDField;
    SQLVendasCUPON2TOTITENSRET: TBCDField;
    ...
    lbMotoboy: TppLabel;
    SQLVendasCUPON3CREDTAXA: TBCDField;
    ...
    SQLVendasPorVendedorTOTALVENDEDOR: TBCDField;
    ...
    SQLVendasCanceladasTOTALITEM: TBCDField;
...
begin
  ...
  if not ckBobina.checked then
    ...
    begin
      ...
      if (HoraInicial.Text = '') and (HoraFinal.Text = '') then
        SQLVendasPorVendedor.MacroByName('MData').Value := 'CUPODEMIS >= "' + FormatDateTime('mm/dd/yyyy', De.Date) + '" and ' +
                                                           'CUPODEMIS <= "' + FormatDateTime('mm/dd/yyyy', Ate.Date) + '"'
      else
        SQLVendasPorVendedor.MacroByName('MData').Value := 'REGISTRO >= "' + FormatDateTime('mm/dd/yyyy ', De.Date) + HoraInicial.Text + '" and ' +
                                                           'REGISTRO <= "' + FormatDateTime('mm/dd/yyyy ', Ate.Date)+ HoraFinal.Text   + '"';
      ...
      if ComboTerminal2.Value <> '' then
        SQLVendasPorVendedor.MacroByName('MTerminal').Value := SQLVendas.MacroByName('MTerminal').Value + ' or ' +
                                                    'TERMICOD = ' + ComboTerminal2.Value;
      ...
      if (HoraInicial.Text = '') and (HoraFinal.Text = '') then
        SQLVendasCanceladas.MacroByName('MData').Value := 'REGISTRO >= "' + FormatDateTime('mm/dd/yyyy', De.Date) + ' 00:00:01" and ' +
                                                          'REGISTRO <= "' + FormatDateTime('mm/dd/yyyy', Ate.Date) + ' 23:59:59"'
      else
        SQLVendasCanceladas.MacroByName('MData').Value := 'REGISTRO >= "' + FormatDateTime('mm/dd/yyyy ', De.Date) + HoraInicial.Text + '" and ' +
                                                          'REGISTRO <= "' + FormatDateTime('mm/dd/yyyy ', Ate.Date)+ HoraFinal.Text   + '"';
      ...
      if ComboTerminal2.Value <> '' then
        SQLVendasCanceladas.MacroByName('MTerminal').Value := SQLVendas.MacroByName('MTerminal').Value + ' or ' +
                                                    'TERMICOD = ' + ComboTerminal2.Value;
      ...
      if ckItensVendidos.Checked then
        begin
          ...
          if (HoraInicial.Text = '') and (HoraInicial.Text = '') then
            ...
            SQLItensVendidos.MacroByName('MData').Value := 'CUPOM.REGISTRO >= "' + FormatDateTime('mm/dd/yyyy ', De.Date) + HoraInicial.Text + '" and ' +
                                                           'CUPOM.REGISTRO <= "' + FormatDateTime('mm/dd/yyyy ', Ate.Date)+ HoraFinal.Text   + '"';
...
procedure TFormPrincipalRelatorios.ppDetailBand3BeforePrint(
  Sender: TObject);
begin
  lbMotoboy.caption := dm.SQLLocate('MOTOBOY','MTBYICOD','MTBYA30DESCR',SQLVendasMTBYICOD.AsString);
end;

procedure TFormPrincipalRelatorios.ppSummaryBand2BeforePrint(
  Sender: TObject);
begin
