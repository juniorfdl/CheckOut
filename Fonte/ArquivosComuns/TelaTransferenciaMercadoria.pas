...
uses
  ...
  AdvOfficeStatusBar, AdvOfficeStatusBarStylers, DBClient;
...
procedure TFormTelaTransferencia.cdsTranferenciaOnlineBeforePost(
  DataSet: TDataSet);
begin
  inherited;
  GravarDadosOnline(DataSet);
...
procedure TFormTelaTransferencia.cdsTranferenciaItemOnlineBeforePost(
  DataSet: TDataSet);
begin
  inherited;
  if rgOnOff.ItemIndex = 1 then
